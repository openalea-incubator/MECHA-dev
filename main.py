...
# Define here variables that will be global
...
Xwalls = None
PileUp = None
passage_cell_ID = None
InterCid = None
InterC_perim_search = None
InterC_perim1 = None
InterC_perim2 = None
InterC_perim3 = None
InterC_perim4 = None
...
# ================================================
# DEFINE FUNCTIONS THAT WILL USE GLOBAL VARIABLES
# ================================================
...
def MECHA_run(dir, Project, 
    ...
    t0 = time.perf_counter()
    Cell_rank, Layer_dist, nLayer, xyl_dist, Layer_dist, nLayer, InterCid, Nsieve, Nprotosieve, listprotosieve, outercortex_connec_rank, xyl80_dist  = compute_AQP_axial_distribution(G,Ncells, Cell2Wall_loop, position, NwallsJun, 
                                                                                                                                                         x_grav, y_grav, 
                                                                                                                                                         Ncellperimeters,nCell_connec, Cell_connec, InterCid,
                                                                                                                                                         InterC_perim_search,
                                                                                                                                                         listsieve, listxyl
                                                                                                                                                         )
    t1 = time.perf_counter()
    ...
    for h in range(Nhydraulics):
        ...
        for iMaturity in range(Nmaturity_loop):
            ...
            #=============================================================================
            # HUGE FUNCTION TO WRITE DOWN MACROPROPS
            write_macro(text_file, newpath, b, iMaturity, Nscenarios, Totheight, 
                        NWallLayer, PsiWallLayer,
                        Nlayers, PileUp, Barriers, perimeter, K_xyl_spec, kr_tot,
